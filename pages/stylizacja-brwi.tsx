...
function StylizacjaBrwi() {
  return (
    <EyebrowPageContainer>
      <NextSeo title="Stylizacja brwi - Ozimek, okolice Opola" description="stylizacja rzęs - ozimek" />
      ...
      <StyledArticle>
        ...
        <StyledSection>
          Jest to jeden z najbardziej pożądanych zabiegów ostatnich miesięcy. To nie jest tradycyjna
          henna! Dlaczego? Ponieważ trzyma dłużej niż tradycyjna henna, a kolory wychodzą piękne i
          naturalne. Najbardziej jednak świat pokochał BROW HENNĘ za naturalny skład oraz
          dobroczynny wpływ na skórę i włoski.
        </StyledSection>
        <StyledStep>Krok 1</StyledStep>
        <StyledSection>
          Wykonanie peelingu lub masażu jednorazową szczoteczką w celu złuszczenia martwych komórek
          naskórka, dzięki czemu uzyskamy jednolity kolor henny i lepszą trwałość.
        </StyledSection>
        <StyledStep>Krok 2</StyledStep>
        <StyledSection>
          Architektura, geometria to inaczej rysunek wstępny brwi dobrany indywidualnie do klientki
        ...
        <StyledSection>
          ...
          uzyskać efekt ombre. Jest on bardzo szeroko omawiany na szkolniach, w których uczestniczę.
        </StyledSection>
        <StyledSection>
          Regularnie wykonywana henna tego typu wzmacnia, zagęszcza i pobudza do wzrostu brwi słabe
          i rzadkie. Tak więc to nie jest tylko chwilowy efekt koloryzacji, ale też cudowny zabieg
          regeneracyjny.
        </StyledSection>
      </StyledArticle>
    </EyebrowPageContainer>
